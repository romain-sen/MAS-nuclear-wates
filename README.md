...
|                                                                before                                                                 |                                                                                         After                                                                                         |
| :-----------------------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|                                  ![Results of the strategy 3 with issue](./assets/Strat3-issue.png)                                   |                                                       ![Results of the strategy 3 with improvement](./assets/Strat3-scaled.png)                                                       |
| Here, we scaled the previous improved strategy to a bigger grid, but in average, it is around only 25% of the waste that are cleaned. | By seperating the deposits, we can now scale the strategy to bigger grids and clean all the wastes. Here, with a 60x50 grid, almost all runs cleaned all the wastes under 1500 steps. |
