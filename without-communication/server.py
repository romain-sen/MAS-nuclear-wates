...
model_params = {
    "n_green_agents": mesa.visualization.Slider("Green Agents", 1, 0, 5),
    "n_yellow_agents": mesa.visualization.Slider("Yellow Agents", 0, 0, 5),
    "n_red_agents": mesa.visualization.Slider("Red Agents", 0, 0, 5),
